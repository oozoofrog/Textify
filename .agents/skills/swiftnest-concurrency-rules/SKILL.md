---
name: "swiftnest-concurrency-rules"
description: "Apply this skill whenever async work, task orchestration, cancellation, or actor correctness is involved."
---

<!-- Generated by SwiftNest for Codex from Docs/AI_SKILLS/concurrency-rules.md. Re-run swiftnest onboard, init, or upgrade after changing selected skills. -->
