---
name: "swiftnest-networking-rules"
description: "Apply this skill whenever API calls, request/response modeling, retries, or remote sync behavior are involved."
---

<!-- Generated by SwiftNest for Codex from Docs/AI_SKILLS/networking-rules.md. Re-run swiftnest onboard, init, or upgrade after changing selected skills. -->
